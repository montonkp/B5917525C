...
export class CaptiveAgentService {
  ...
  public postCaptiveAgent(object: any, genderID: number, subDistrictID: number, districtID: number, provinceID: number): Observable<any> {
    return this.http.post(captiveAgentApi + genderID + '/' + subDistrictID + '/' + districtID + '/' + provinceID, {
